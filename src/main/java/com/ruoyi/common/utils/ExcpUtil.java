...
//		return (new Throwable()).getStackTrace();
    ...
    public static Throwable wrapPrintStackDepth(Throwable e, int depth) {
        StackTraceElement[] stackTraceElements = e.getStackTrace();
        int copyLength = stackTraceElements.length > depth ? depth : stackTraceElements.length;
        StackTraceElement[] clone = new StackTraceElement[copyLength];
        System.arraycopy(stackTraceElements, 0, clone, 0, copyLength);
        e.setStackTrace(clone);
        return e;
    }

    public static Throwable wrapPrintStackDepth(Throwable e) {
        return wrapPrintStackDepth(e, 15);
    }
}
